...
namespace opieandanthonylive.Terminal.Media.Metadata
{
		...
		: ShellRefObject
	{
		...
		public static ShellRefProperty<string> DescriptionProperty =
			SRP.Register<AudioShellObject, string>(
				SystemProperties.System.DRM.Description);

		public static ShellRefProperty<string> CommentProperty =
			SRP.Register<AudioShellObject, string>(
				SystemProperties.System.DRM.Description);

		public static ShellRefProperty<string> DisplayNameProperty =
			SRP.Register<AudioShellObject, string>(
				SystemProperties.System.Identity.DisplayName);

		public static ShellRefProperty<string> ContentDistributorProperty =
			SRP.Register<AudioShellObject, string>(
				SystemProperties.System.Media.ContentDistributor);

		public static ShellRefProperty<string> EncodedByProperty =
			SRP.Register<AudioShellObject, string>(
				SystemProperties.System.Media.EncodedBy);

		public static ShellRefProperty<int> FrameCountProperty =
			SRP.Register<AudioShellObject, int>(
				SystemProperties.System.Media.FrameCount);
		...
		//DisplayName ContentDistributor EncodedBy FrameCount Publisher Subtitle Year TrackNumber
		...
		{
			get => DescriptionProperty.GetValueBase(this);
			set => DescriptionProperty.SetValueBase(this, value);
		}

		public string Comment
		{
			get => CommentProperty.GetValueBase(this);
			set => CommentProperty.SetValueBase(this, value);
		}

		public string DisplayName
		{
			get => DisplayNameProperty.GetValueBase(this);
			set => DisplayNameProperty.SetValueBase(this, value);
		}

		public string ContentDistributor
		{
			get => ContentDistributorProperty.GetValueBase(this);
			set => ContentDistributorProperty.SetValueBase(this, value);
		}
		...
		{
			get => FrameCountProperty.GetValueBase(this);
			set => FrameCountProperty.SetValueBase(this, value);
		}
